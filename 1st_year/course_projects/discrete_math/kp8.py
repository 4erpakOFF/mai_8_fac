...
Str=input("Задайте группу в следующем формате:\n  < [Cписок образующих] | [Cписок определяющих соотношений] >\n\n")
while Str.find('<')==-1 or Str.find('>')==-1:
    Str+=input()
Str_copy=Str
Generators,Basic,Relations = interpretation(Str)
Words=[]+Basic
...
plt.text(0.9, 1.25,'Generators:', style='italic',fontsize=15,bbox={'facecolor':'yellow', 'alpha':0.0,'linewidth':0.0, 'pad':4})
y=1.09
for i in range( len(Generators) ):
